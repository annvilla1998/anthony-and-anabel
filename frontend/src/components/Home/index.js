...
import rosesLeft from "../../assets/rosesLeft.png"
import rosesRight from "../../assets/rosesRight.png"
  ...
  return (
    <div className="home card">
      <div className="flex items-start sm:items-center">
        <img alt="roses" className="w-20 sm:w-1/5" src={rosesLeft} />
        ...
        <img alt="roses" className="w-20 sm:w-1/5" src={rosesRight} />
      </div>
      <figure>
        <img
          src={cover}
